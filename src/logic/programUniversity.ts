...
export const getProgramUniversity = async (req: Request<{}, {}, programFields>, res: Response) => {
    const { 
        program_id,
        inst_id,
        program_name,
...
export const createProgramUniversity = async (req: Request<{}, {}, programFields>, res: Response) => {
    const {
        inst_id,
        program_name,
        program_type,
...
export const updateProgramUniversity = async (req: Request<{}, {}, programFields>, res: Response) => {
    const {
        program_id,
        inst_id,
        program_name,
